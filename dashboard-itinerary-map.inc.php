...
$pluginI18n = [
    ...
    'itin.view.map'              => $lang['itin.view.map'] ?? '',
    'itin.view.story'            => $lang['itin.view.story'] ?? '',
    'itin.story.otherPois'       => $lang['itin.story.otherPois'] ?? '',
    'itin.story.btn.export'      => $lang['itin.story.btn.export'] ?? '',
    'itin.story.btn.exportPdf'   => $lang['itin.story.btn.exportPdf'] ?? '',
    'itin.story.error.pdfExport' => $lang['itin.story.error.pdfExport'] ?? '',
];
